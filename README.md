...
**Note** you should however be ware of some of the langauage/ nomenclature used in documentation/UI. This may refer to *on-premises* which in our case would mean *Azure*; a *local site* or *network* or *instance* would refer to *Azure*; and a *Physical* machine in the UI would be an *Azure VM*. 
